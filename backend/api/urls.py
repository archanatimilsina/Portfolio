...
urlpatterns = [
    ...
    path('blog/images/', BlogImageUploadAPIView.as_view(), name='blog-image-upload'),
    path('blog/posts/', BlogPostListCreateAPIView.as_view(), name='blog-post-list-create'),
    path('blog/posts/stats/', BlogPostStatsAPIView.as_view(), name='blog-post-stats'),
